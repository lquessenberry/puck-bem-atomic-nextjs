  ...
  zones: {
    root: [
          ...
          stats: [
            {
              id: "stat-velocity",
              value: "3x",
              label: "Faster launch velocity",
            },
            {
              id: "stat-universes",
              value: "4",
              label: "Built-in design universes",
            },
            { id: "stat-touch-target", value: "3rem", label: "Min tap target" },
            {
              id: "stat-token-driven",
              value: "100%",
              label: "Token-driven components",
            },
          ],
        },
      },
          ...
          items: [
            {
              ...
              description:
                "A complete token layer powers color, spacing, type, radius, motion, and shadow.",
            },
            {
              ...
              title: "Strict BEM",
              description:
                "Consistent naming and isolated SCSS modules keep complexity low.",
            },
            {
              ...
              title: "Puck-ready",
              description:
                "A powerful editor config with categorized components and sensible defaults.",
            },
          ],
        },
      },
      ...
      },
      {
        ...
        props: {
          quote:
            "AtomicPuck gave us the premium baseline we needed to ship faster without sacrificing quality.",
          author: "Jordan Lee",
          role: "Product Lead",
          company: "Cloudline",
          rating: 5,
